...
LR_x_train = np.column_stack((xgb_train_predicted, lb_train_predicted, cb_train_predicted))
LR_x_test = np.column_stack((xgb_test_predicted, lb_test_predicted, cb_test_predicted))
LR_x_submit = np.column_stack((xgb_submit, lb_submit, cb_submit))
